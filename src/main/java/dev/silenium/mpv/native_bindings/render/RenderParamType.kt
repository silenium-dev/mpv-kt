...
enum class RenderParamType(override val value: Int) : NativeEnum<RenderParamType> {
    /**
     ...
     *      Providing OPENGL_INIT_PARAMS is required.
    ...
    /**
     * Deprecated. Not supported. Use DRM_DISPLAY_V2 instead.
     ...
     * for the surface width as specified by SW_SIZE.
     *
     ...
     * writable.
     *
     * See SW_STRIDE for alignment requirements.
     */
    SW_POINTER(20),
}
